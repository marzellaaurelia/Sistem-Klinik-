    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index2.html" class="logo">
                ...
                <span class="logo-lg"><b>Sistem Klinik</b></span>
            </a>
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    <?php if (Yii::$app->user->identity->role == 'Admin') : ?>
                        ...
                        <li <?= Yii::$app->controller->id == 'transaksi' ? 'class=active' : '' ?>>
                            <a href="<?= Url::toRoute(['/transaksi']) ?>">
                                <i class="fa fa-tag"></i> <span>Transaksi</span>
                            </a>
                        </li>

                        <li <?= Yii::$app->controller->id == 'obat' ? 'class=active' : '' ?>>
                            <a href="<?= Url::toRoute(['/obat']) ?>">
                                <i class="fa fa-medkit"></i> <span>Obat</span>
                            </a>
                        </li>

                        <li <?= Yii::$app->controller->id == 'poli' ? 'class=active' : '' ?>>
                            <a href="<?= Url::toRoute(['/poli']) ?>">
                                <i class="fa fa-stethoscope"></i> <span>Poli</span>
                            </a>
                        </li>

                        <li <?= Yii::$app->controller->id == 'pendaftaran' ? 'class=active' : '' ?>>
                            <a href="<?= Url::toRoute(['/pendaftaran']) ?>">
                                <i class="fa fa-book"></i> <span>Pendaftaran</span>
                            </a>
                        </li>

                        <li <?= Yii::$app->controller->id == 'resep' ? 'class=active' : '' ?>>
                            <a href="<?= Url::toRoute(['/resep']) ?>">
                                <i class="fa fa-edit"></i> <span>Resep</span>
                            </a>
                        </li>
                        ...
                        <li <?= Yii::$app->controller->id == 'dokter' ? 'class=active' : '' ?>>
                            <a href="<?= Url::toRoute(['/dokter']) ?>">
                                <i class="fa fa-user-md"></i> <span>Data Dokter</span>
                            </a>
                        </li>

                        <li <?= Yii::$app->controller->id == 'pegawai' ? 'class=active' : '' ?>>
                            <a href="<?= Url::toRoute(['/pegawai']) ?>">
                                <i class="fa fa-user"></i> <span>Data Pegawai</span>
                            </a>
                        </li>

                        <li <?= Yii::$app->controller->id == 'apoteker' ? 'class=active' : '' ?>>
                            <a href="<?= Url::toRoute(['/apoteker']) ?>">
                                <i class="fa fa-user"></i> <span>Data Apoteker</span>
                            </a>
                        </li>
                    <?php endif; ?>
